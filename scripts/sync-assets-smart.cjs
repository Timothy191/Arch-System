 ...
 *
 * Purpose:
 * This script smartly synchronizes assets by checking if any files in the `shared/`
...
const ASSETS_DIR = path.join(REPO_ROOT, "shared");
...
if (!existsSync(ASSETS_DIR)) {
  console.log("⚠️  No shared/ directory found. Skipping sync.");
  process.exit(0);
}
