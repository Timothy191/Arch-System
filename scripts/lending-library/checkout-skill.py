...
def main() -> int:
    ...
    try:
        ...
        print("HINT: python3 scripts/lending-library/list-catalog.py skills", file=sys.stderr)
        return 1
    ...
    if record.get("ephemeral"):
        ...
        print("RETURN: python3 scripts/lending-library/return-skill.py", args.skill_name)
