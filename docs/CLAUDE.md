...
> **Claude Code Onboarding & Operational Guide** — Read first before making any changes.  
> This document provides technical guidance, rules, and context for Claude when working in this repository.  
> **Non-compliance with mandatory rules is a violation of agent contracts.**
