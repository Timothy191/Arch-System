...
- [ ] **Machine Registration**
  ...
  - **Migration:** `packages/database/migrations/049_control_room_dumpers.sql`
...
- **Files:** Create `app/api/health/fuxa/route.ts`, `app/api/health/supabase-realtime/route.ts`, `app/api/health/redis/route.ts`
...
- **Database:** `packages/database/migrations/046_control_room_archiving.sql`, `049_control_room_dumpers.sql`
