...
- **Background Video**: Fixed high-resolution loop representing active operations (`/background/white-geometric-waves.3840x2160.mp4`). It is overlayed with a subtle white glass tint (`.route-bg-tint`) to ensure contrast and readability of form elements.
...
- **Hero section:** The hub hero uses the global `RouteBackground` video layer; glass cards sit above it with no separate page background.
