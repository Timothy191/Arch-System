...
export default defineConfig({
  ...
  themeConfig: {
      ...
      "/": [
        ...
        },
        {
          ...
          items: [
            { text: "Architecture Overview", link: "/entities/arch-systems" },
            {
              ...
              link: "/concepts/turborepo-monorepo",
            },
            {
              text: "Portal App Architecture",
              link: "/concepts/portal-app-architecture",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Supabase Local Dev",
              link: "/concepts/supabase-local-dev",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Department Features",
              link: "/concepts/department-features",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "ADR-001: Next.js App Router",
              link: "/concepts/adr-001-nextjs-app-router",
            },
            {
              text: "ADR-002: Supabase Backend",
              link: "/concepts/adr-002-supabase-backend",
            },
            {
              text: "ADR-003: Turborepo",
              link: "/concepts/adr-003-turborepo-monorepo",
            },
            {
              text: "ADR-004: Tailwind Design",
              link: "/concepts/adr-004-tailwind-design-system",
            },
            {
              text: "ADR-005: Zustand State",
              link: "/concepts/adr-005-zustand-state-management",
            },
            {
              text: "ADR-006: Multi-Provider AI",
              link: "/concepts/adr-006-multi-provider-ai",
            },
            {
              text: "ADR-007: React 19",
              link: "/concepts/adr-007-react-19-adoption",
            },
          ],
        },
        {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/DRACOSFN/Turborepo-Fullstack-Starter-Template",
      },
    ],
