 ...
 */
//
// Static RLS policy audit for pkgs/database/migrations/*.sql.
//
...
const MIGRATIONS_DIR = path.join(ROOT, "pkgs", "database", "migrations");
...
/**
 * Lists all SQL migration files in pkgs/database/migrations in numeric order.
 *
