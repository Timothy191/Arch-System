...
const archTheme: Config = {
  content: [
    ...
    "./app/**/*.{ts,tsx}",
    "./src/**/*.{ts,tsx}",
    "../../01_platform_packages/ui/src/**/*.{ts,tsx}",
    "../../01_platform_packages/theme/src/**/*.{ts,tsx}",
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "color-signin-button": "var(--color-signin-button)",
        "color-signin-button-hover": "var(--color-signin-button-hover)",
