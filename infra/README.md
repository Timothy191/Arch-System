...
- **[redis/](file:///home/timothy/Documents/Arch-System/infra/redis)**: Redis caching configurations:
  - `config/shard-map.json`: Active routing shard mapping.
...
- Terraform (if provisioning components via `/redis/terraform/`)
