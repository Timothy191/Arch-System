...
- pnpm 9.15.9
- Docker (for Supabase)
- Valid `00_applications/portal/.env` file
...
- `.env` (root)
- `00_applications/portal/.env`
- `01_platform_packages/supabase/config.toml`
...
**Output**: `06_technical_documentation/database/`
...
# Edit 00_applications/portal/.env with production values
...
cd 01_platform_packages/database && pnpx supabase status
```
...
```bash
./03_operations_automation/backup-db.sh                                # Run a backup now
DATABASE_URL=postgresql://user:pass@host:5432/db ./03_operations_automation/backup-db.sh  # Override connection
```

**Output in `03_operations_automation/backups/`**:
...
0 3 * * * cd /path/to/arch-system && ./03_operations_automation/backup-db.sh
```
...
./03_operations_automation/restore-db.sh

# Restore a specific backup
./03_operations_automation/restore-db.sh 2026-06-16_143022

# Non-interactive restore (CI/automation — use with extreme caution)
FORCE_RESTORE=true ./03_operations_automation/restore-db.sh 2026-06-16_143022
```
...
**Note**: `ROCKY_LINUX_COMPATIBILITY.md` was moved to `06_technical_documentation/ROCKY_LINUX_COMPATIBILITY.md` as it is documentation, not an executable script.
...
- **[CONTROL_ROOM_IMPLEMENTATION_TODO.md](../00_applications/portal/CONTROL_ROOM_IMPLEMENTATION_TODO.md)** - Control Room department implementation status
- **[DELAY_TRACKING_TEST_PLAN.md](../00_applications/portal/DELAY_TRACKING_TEST_PLAN.md)** - Delay tracking feature test plan
...
- `00_applications/portal/app/(departments)/[department]/machine-operations/DelayEntriesForm.tsx`
- `00_applications/portal/AGENT_TRACER.md` (agent tracing updates)
- `00_applications/portal/DELAY_TRACKING_TEST_PLAN.md` (new test plan)
