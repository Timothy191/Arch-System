...
def classify(text: str, explicit: str | None = None) -> dict:
    ...
    paths = {
        ...
        "high": {
            "plan": "HOW.md full checklist + 03_operations_automation/agent-orchestrator/dynamic-workflow.md",
            ...
            "verify_gate": "03_operations_automation/agent-orchestrator/verify-gate.sh before claiming done",
