...
TOOLS_COMPOSE="$REPO_ROOT/10_infrastructure_as_code/docker/compose.tools.yml"
REDIS_COMPOSE="$REPO_ROOT/12_distributed_cache_runtime/docker-compose.yml"
MONITOR_COMPOSE="$REPO_ROOT/10_infrastructure_as_code/14_observability_configuration/docker-compose.yml"
...
ENV_FILE="$REPO_ROOT/00_applications/portal/.env"
ENV_BAK="$REPO_ROOT/00_applications/portal/.env.bak"
if [ -f "$ENV_BAK" ]; then
