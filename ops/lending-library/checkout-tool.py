...
def main() -> int:
    ...
    try:
        ...
        print("HINT: python3 03_operations_automation/lending-library/list-catalog.py tools", file=sys.stderr)
        return 1
    ...
    if record.get("ephemeral"):
        ...
        print("RETURN: python3 03_operations_automation/lending-library/return-tool.py", args.tool_name)
    return 0
