...
# Usage: ./ops/preflight-checklist.sh [--fix]
#
...
[ -d "$DATABASE_DIR" ]   && check_pass "pkgs/database" || check_fail "pkgs/database missing"
...
SERVICE_FILE="$HOME/.toolchain/infra/systemd/user/arch-systems.service"
