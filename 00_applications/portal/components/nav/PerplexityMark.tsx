...
type PerplexityMarkProps = {
  className?: string;
};

/** Perplexity brand mark for taskbar search (simple-icons path, currentColor). */
export function PerplexityMark({ className }: PerplexityMarkProps) {
  return (
    <svg
      role="img"
      aria-hidden="true"
