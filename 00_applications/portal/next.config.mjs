...
/** @type {import('next').NextConfig} */const nextConfig = {
  turbopack: {
    // AGENT-TRACE: Root must include workspaceRoot to allow dependencies from 01_platform_packages/ to be compiled
    root: workspaceRoot,
    resolveAlias: {
      "lucide-react": "./00_applications/portal/node_modules/lucide-react",
      sonner: "./00_applications/portal/node_modules/sonner",
      "framer-motion": "./00_applications/portal/node_modules/framer-motion",
    },
  },
