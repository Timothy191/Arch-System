...
- **[Skill Registry & Tooling Directives](./skill-registry.md)**: Installed skill ecosystem, `npx skills add` installation protocol, and spec blueprint automation with `mmx-cli`.
- **[AI Framework Landscape](./agentic-ai-frameworks.md)**: Overview of foundational LLM architectures and tooling agents.

---

## Living Documentation Cross-References
...
- **AI Conventions & Rules**: [`docs/GEMINI.md`](../../../docs/GEMINI.md)
- **Agent Package Code**: [`packages/agents/src/`](../src/)
