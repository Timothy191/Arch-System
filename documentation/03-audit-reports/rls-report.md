...
Generated by `tools/audits/audit-rls.cjs` from `packages/database/migrations`.
...
| `agent_governance_events` | 20260912_agent_governance_telemetry.sql, 20260912_codemod_migration_ledger.sql |
...
| `machines` | 001_initial.sql, 20260911_control_room_hardening.sql |
| `material_density` | 073_production_summary_view.sql, 093_enable_rls_material_density.sql |
