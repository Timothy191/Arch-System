...
**Location:** `00_applications/portal/components/dynamic/LazyHeavyComponents.tsx`
...
See `00_applications/portal/app/(departments)/[department]/hourly-loads/HourlyLoadsGrid.tsx` for a working example of DataGrid usage with the new lazy loading pattern.
...
- [Lazy Loading in Next.js](https://nextjs.org/06_technical_documentation/app/building-your-application/optimizing/lazy-loading)
- [Next.js Dynamic Import API](https://nextjs.org/06_technical_documentation/app/api-reference/functions/dynamic-import)
- [Bundle Size Monitoring](../03_operations_automation/monitor-bundle-size.sh)
