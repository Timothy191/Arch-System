...
export function ProductionTrendChart({ data, showForecast = true }: ProductionTrendChartProps) {
  // BOLT OPTIMIZATION: Memoize linear forecast calculation and chart data formatting.
  // Preserves referential equality for `chartData` and `categories` to prevent unnecessary SVG chart re-diffing
  // and avoids re-running linear regression on every parent re-render.
