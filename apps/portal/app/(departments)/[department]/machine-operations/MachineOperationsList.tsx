...
function MachineOperationsList({
  ...
  // Pre-index total loads by machine_id to replace nested O(N*M) array filtering with O(1) Map lookups
...
function OperationCard({
  ...
  // Calculate BCM metrics using O(1) pre-indexed machineLoads
