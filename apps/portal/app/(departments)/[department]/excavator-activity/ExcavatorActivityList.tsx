...
export function ExcavatorActivityList({
  ...
  // AGENT-TRACE: Pre-index todayAssignments by excavator_activity_id to replace nested O(N * M) .filter() array scans with O(1) Map lookups
...
// AGENT-TRACE: Memoize ActivityCard — props (activity, assignments) are stable across renders
