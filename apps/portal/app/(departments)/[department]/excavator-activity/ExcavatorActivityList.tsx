...
export function ExcavatorActivityList({
  ...
  // Performance Pattern: Index assignments by excavator_activity_id into a Map to replace O(N * M) nested .filter() calls with O(1) lookups during render.
  ...
  // Pre-compute site grouping & sorting to avoid map creation and array sorting on every render
