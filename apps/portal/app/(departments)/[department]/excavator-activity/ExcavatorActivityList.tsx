...
export function ExcavatorActivityList({
  ...
  // Bolt Optimization: Pre-index dumper assignments into a Map keyed by excavator_activity_id.
  // Replaces repeated O(N * M) .filter() array iterations per render with O(1) Map lookups.
