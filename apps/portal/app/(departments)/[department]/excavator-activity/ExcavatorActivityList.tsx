...
export function ExcavatorActivityList({
  ...
  // Performance Optimization: Pre-index dumper assignments into a Map keyed by excavator_activity_id
  // This converts repeated nested array .filter() operations O(A * N) into O(A + N) Map lookups.
  ...
  // Group by site_id and sort entries, memoized to prevent re-grouping on unrelated renders
