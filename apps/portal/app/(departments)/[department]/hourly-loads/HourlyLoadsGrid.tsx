...
export function HourlyLoadsGrid({
  ...
  // Performance Optimization: Memoize derived Map to stabilize downstream hooks
  // and prevent unnecessary DataGrid (RevoGrid) re-renders.
  ...
  // Performance Optimization: Memoize department-level flag to avoid O(N) check on each render
