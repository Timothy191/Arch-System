...
export function HourlyLoadsGrid({
  ...
  // Memoize the loads map to prevent unnecessary re-renders and stabilize dependent callbacks.
  // Use a composite key to handle multiple shifts for the same machine.
