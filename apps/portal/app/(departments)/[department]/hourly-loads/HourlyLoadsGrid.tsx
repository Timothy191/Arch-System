...
export function HourlyLoadsGrid({
  ...
  // Memoize lookup map to prevent recreation on every render, stabilizing callback references.
  // Use a composite key machine_id:shift_type to prevent day/night shift records for the same machine from overwriting each other.
