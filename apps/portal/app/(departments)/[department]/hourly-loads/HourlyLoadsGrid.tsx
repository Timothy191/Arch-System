...
export function HourlyLoadsGrid({
  ...
  // Bolt Optimization: Memoize composite key lookup Map to prevent allocation on every render
  // and use machine_id:shift_type composite keys to prevent day/night shift data collisions.
