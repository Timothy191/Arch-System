...
export const shiftCloseoutDuration = new promClient.Histogram({
...
export const shiftCloseoutTotal = new promClient.Counter({
  name: "control_room_shift_closeout_total",
  help: "Total number of shift closeout attempts",
  labelNames: ["department_id", "shift_type", "success"],
});

export const shiftCloseoutValidationErrors = new promClient.Counter({
...
export const machineStatusUpdateDuration = new promClient.Histogram({
...
export const machineStatusUpdateTotal = new promClient.Counter({
...
export const scadaPanelLoadDuration = new promClient.Histogram({
...
export const scadaFetchMachineDuration = new promClient.Histogram({
...
export const scadaConnectionStatus = new promClient.Gauge({
...
export const alertPanelLoadDuration = new promClient.Histogram({
...
export const alertCount = new promClient.Gauge({
...
export const hourlyLoadsUpdateDuration = new promClient.Histogram({
...
export const hourlyLoadsUpdateTotal = new promClient.Counter({
...
export const apiTotalRequests = new promClient.Counter({
...
/**
 * Helper function to time a function and record to histogram
 */
