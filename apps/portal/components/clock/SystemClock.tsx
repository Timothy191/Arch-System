...
export function SystemClock() {
  ...
  // Performance Optimization: Update the analog clock every second ONLY when the Popover is open.
  // This prevents unnecessary high-frequency background re-renders when the clock is not visible.
  useEffect(() => {
    if (!isOpen) return;

    // Immediately sync the time when opened to avoid staleness/delay
    setTime(new Date());
