...
export function SystemClock() {
  ...
  // Update the analog clock every second, conditional on Popover visibility to prevent unnecessary background re-renders.
  useEffect(() => {
    if (!isOpen) return;

    // Synchronize immediately upon opening to prevent any clock staleness.
    setTime(new Date());
