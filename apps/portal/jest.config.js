module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^@repo/feature-auth-ui$": "<rootDir>/../../packages/features/auth/ui/src/index.ts",
    "^@repo/feature-auth-ui/(.*)$": "<rootDir>/../../packages/features/auth/ui/src/$1",
    "^@repo/feature-auth-utils$": "<rootDir>/../../packages/features/auth/utils/src/index.ts",
    "^@repo/feature-auth-utils/(.*)$": "<rootDir>/../../packages/features/auth/utils/src/$1",
    "^@repo/feature-auth-data-access$": "<rootDir>/../../packages/features/auth/data-access/src/index.ts",
    "^@repo/feature-auth-data-access/(.*)$": "<rootDir>/../../packages/features/auth/data-access/src/$1",
