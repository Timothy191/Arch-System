/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c3a311a2df8cc7e4b08753247f02cde)
// Runtime types generated with workerd@1.20260710.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	SPATIAL_TELEMETRY_BUCKET: R2Bucket;
	ENVIRONMENT: "production";
	FUXA_SCADA_URL: "https://fuxa.production-mining.com";
	SHIFT_REPORT_WORKFLOW: Workflow<Parameters<import("./src/index").ShiftReportWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FUXA_SCADA_URL">> {}
}
