...
describe("LoginForm", () => {
  ...
  it("renders employee ID and password inputs", () => {
    ...
    expect(signInBtn.className).toContain("liquid-glass-button-signin");
    expect(signInBtn.className).toContain("bg-[var(--color-signin-button)]");
    expect(signInBtn.className).toContain("hover:bg-[var(--color-signin-button-hover)]");
