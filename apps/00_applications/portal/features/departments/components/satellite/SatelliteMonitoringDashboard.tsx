...
const LidarLayerPanel = dynamic(
  () => import("@/components/obs/LidarLayer").then((m) => m.LidarLayerPanel),
  {
    ssr: false,
    loading: () => (
...
const COGRasterLayer = dynamic(
  () => import("@/components/obs/COGRasterLayer").then((m) => m.COGRasterLayer),
  {
    ssr: false,
    loading: () => (
      <div className="h-[340px] bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-xl animate-pulse" />
...
const KeplerGlMap = dynamic(
  () => import("@/components/obs/KeplerGlMap").then((m) => m.KeplerGlMap),
  {
    ssr: false,
    loading: () => (
      <div className="h-[340px] bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-xl animate-pulse" />
...
const MonitoringMap = dynamic(
  () => import("@/components/obs/MonitoringMap").then((m) => m.MonitoringMap),
  {
    ssr: false,
    loading: () => (
