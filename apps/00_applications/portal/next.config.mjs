...
/** @type {import('next').NextConfig} */const nextConfig = {
  turbopack: {
    // AGENT-TRACE: Root must include workspaceRoot to allow dependencies from pkgs/ to be compiled
    root: workspaceRoot,
    resolveAlias: {
      "lucide-react": "./apps/portal/node_modules/lucide-react",
      sonner: "./apps/portal/node_modules/sonner",
      "framer-motion": "./apps/portal/node_modules/framer-motion",
    },
  },
