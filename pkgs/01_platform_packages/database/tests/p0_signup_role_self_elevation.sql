...
-- 01_platform_packages/database/migrations/001_initial.sql) reads
...
-- like 01_platform_packages/database/migrations/052_seed_admin_user.sql).
--
...
--     -f 01_platform_packages/database/tests/p0_signup_role_self_elevation.sql
--
