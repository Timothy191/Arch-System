...
**Tracking**: `pkgs/theme/ops/validate-tokens.mjs` warns on deprecated alias usage in
...
it via `ops/generate-tokens.mjs`. The JS values should never be edited manually.
...
Three tiers enforced by `ops/validate-tokens.mjs` and documented inline in `variables.css`:
...
**Decision**: `src/tokens/generated.ts` is machine-generated by `ops/generate-tokens.mjs`
