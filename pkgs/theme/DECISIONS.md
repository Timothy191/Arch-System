...
**Tracking**: `01_platform_packages/theme/03_operations_automation/validate-tokens.mjs` warns on deprecated alias usage in
...
it via `03_operations_automation/generate-tokens.mjs`. The JS values should never be edited manually.
...
Three tiers enforced by `03_operations_automation/validate-tokens.mjs` and documented inline in `variables.css`:
...
**Decision**: `src/tokens/generated.ts` is machine-generated by `03_operations_automation/generate-tokens.mjs`
